...
namespace Nieruchomosci.Intranet.Controllers
{
    public class StronaController : Controller
    {
        ...
        public StronaController(NieruchomosciContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Strona != null ? 
                          ...
                          Problem("Entity set 'NieruchomosciIntranetContext.Strona'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdStrony,LinkTytul,Tytul,Foto,Ikona,Tresc,Pozycja,DataUtworzenia,PracownikDodajacy,DataEdycji,PracownikEdytujacy,DataUsuniecia,PracownikUsuwajacy,CzyAktywny")] Strona strona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdStrony,LinkTytul,Tytul,Foto,Ikona,Tresc,Pozycja,DataUtworzenia,PracownikDodajacy,DataEdycji,PracownikEdytujacy,DataUsuniecia,PracownikUsuwajacy,CzyAktywny")] Strona strona)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NieruchomosciIntranetContext.Strona'  is null.");
            }
            var strona = await _context.Strona.FindAsync(id);
            if (strona != null)
            {
