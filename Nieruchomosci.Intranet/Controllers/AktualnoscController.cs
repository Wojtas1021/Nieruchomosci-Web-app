...
namespace Nieruchomosci.Intranet.Controllers
{
    public class AktualnoscController : Controller
    {
        ...
        public AktualnoscController(NieruchomosciContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Aktualnosc != null ? 
                          ...
                          Problem("Entity set 'NieruchomosciIntranetContext.Aktualnosc'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdAktualnosci,LinkTytul,Tytul,Foto,Ikona,Tresc,Pozycja,Komentarz,DataUtworzenia,PracownikDodajacy,DataEdycji,PracownikEdytujacy,DataUsuniecia,PracownikUsuwajacy,CzyAktywny")] Aktualnosc aktualnosc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAktualnosci,LinkTytul,Tytul,Foto,Ikona,Tresc,Pozycja,Komentarz,DataUtworzenia,PracownikDodajacy,DataEdycji,PracownikEdytujacy,DataUsuniecia,PracownikUsuwajacy,CzyAktywny")] Aktualnosc aktualnosc)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NieruchomosciIntranetContext.Aktualnosc'  is null.");
            }
            var aktualnosc = await _context.Aktualnosc.FindAsync(id);
            if (aktualnosc != null)
            {
